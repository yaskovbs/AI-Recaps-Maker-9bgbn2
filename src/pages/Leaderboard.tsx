...
export default function Leaderboard(){
 ...
 useEffect(()=>{(async()=>{const{data}=await supabase.rpc('get_leaderboard',{p_limit:25});setRows(data||[]);setLoading(false);})();},[leaderboardOptIn]);
